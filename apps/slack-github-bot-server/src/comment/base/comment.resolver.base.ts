...
export class CommentResolverBase {
  ...
  async createComment(
    ...
    return await this.service.createComment({
      ...
      data: {
        ...
        pullRequest: args.data.pullRequest
          ? {
              connect: args.data.pullRequest,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => PullRequest, {
    nullable: true,
    name: "pullRequest",
  })
  async getPullRequest(
    ...
    const result = await this.service.getPullRequest(parent.id);
