...
@InputType()
class PullRequestCreateNestedManyWithoutRepositoriesInput {
...
export { PullRequestCreateNestedManyWithoutRepositoriesInput as PullRequestCreateNestedManyWithoutRepositoriesInput };
